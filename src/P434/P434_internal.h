...
#define FP2_ENCODED_BYTES       2*((NBITS_FIELD + 7) / 8)
    ...
    #define FULL_SIGNED         // Uses half the table: if x and x^-1 were in the original table, then only x is stored in full signed table. Must have COMPRESSED_TABLES enabled
#endif
